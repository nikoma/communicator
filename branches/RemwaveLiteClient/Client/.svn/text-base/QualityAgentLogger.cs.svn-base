...
namespace Remwave.Client
{
        ...
        public class QualityAgentLogger : TextWriter
        {
            ...
            {
                FileLocation = Directory.GetCurrentDirectory() + @"\RCS-1.0-Beta-ExceptionLog-" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString("D2") + DateTime.Now.Day.ToString("D2") + ".xml";
