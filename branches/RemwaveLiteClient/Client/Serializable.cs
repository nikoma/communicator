...
namespace Remwave.Client.Serializable
{
    ...
    public class ClientConfigurationSerializer
    {
        ...
        private readonly string ClientConfigurationPath = Environment.GetFolderPath( Environment.SpecialFolder.LocalApplicationData) +@"\"+ Application.CompanyName+@"\"+Application.ProductName+ @"\Client.dat";
